...
public class Apng {
     ...
     * @param output
     */
    public static void transToPng(String input,Integer width,Integer height,Integer frameRate,String output) throws FileNotFoundException, Exception, org.bytedeco.javacv.FrameRecorder.Exception {
        ...
        recorder.setVideoCodec(avcodec.AV_CODEC_ID_APNG);//设置录制的视频/图片编码
        if(frameRate!=null) {
    ...
    public static void main(String[] args) throws Exception, UnsupportedEncodingException, FileNotFoundException, org.bytedeco.javacv.FrameRecorder.Exception {
        ...
        String output="test.apng";
        transToPng(input,300,150,25,output);
    }
}
